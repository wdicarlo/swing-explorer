 ...
 */
public class ActRun extends NodeAction {

    private static final Logger log = Logger.getLogger(ActRun.class.getName());
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        String script = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                ...
                "<jvmarg line=\"-Dswex.mport=" + port + " -Dcom.sun.management.jmxremote -javaagent:&#34;" + homeDir + "/swag.jar&#34; -Xbootclasspath/a:&#34;" + homeDir + "/swag.jar&#34; \"/>" +
                "</java>" +
                "</target>" +
                "</project>";
        try {
    ...
    public String getName() {
        return "Run with Swing Explorer";
    }
